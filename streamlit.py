...
os.system('pip install streamlit==1.11.1')
...
def run ():
    ...
    # Request API
    r = requests.post('http://modelservice.cdswprod.kemenkeu.go.id/model', 
                  data='{"accessKey":"m9vxj8dqk5qwmv7s9biycpszcyycy1du","request":'+ request_json +'}', 
